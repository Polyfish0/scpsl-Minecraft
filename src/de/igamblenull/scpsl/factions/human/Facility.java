package de.igamblenull.scpsl.factions.human;
...
public class Facility implements Human {
    private final String factionName = "facility";
    private final String DisplayFactionName = "Facility";
